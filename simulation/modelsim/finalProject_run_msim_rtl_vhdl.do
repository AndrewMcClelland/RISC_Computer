...
vcom -93 -work work {C:/Users/lukea/Documents/ELEC374_RISC_Computer/phase1_tb_srl.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiii -L rtl_work -L work -voptargs="+acc"  phase1_tb_srl
